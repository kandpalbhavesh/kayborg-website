  ...
  return (
    ...
    >
      {mode === 'target' ? (
        ...
        >
          <circle cx="14" cy="14" r="5" stroke="rgba(255,255,255,0.75)" strokeWidth="1.5"/>
          <line x1="14" y1="0" x2="14" y2="8" stroke="rgba(255,255,255,0.75)" strokeWidth="1.5" strokeLinecap="round"/>
          <line x1="14" y1="20" x2="14" y2="28" stroke="rgba(255,255,255,0.75)" strokeWidth="1.5" strokeLinecap="round"/>
          <line x1="0" y1="14" x2="8" y2="14" stroke="rgba(255,255,255,0.75)" strokeWidth="1.5" strokeLinecap="round"/>
          <line x1="20" y1="14" x2="28" y2="14" stroke="rgba(255,255,255,0.75)" strokeWidth="1.5" strokeLinecap="round"/>
        </svg>
      ) : (
        // Logo mark cursor
        ...
        >
          ...
          <rect x="6" y="8" width="9" height="8" rx="1.5" fill="rgba(255,255,255,0.75)"/>
          <path d="M 17 12 L 22.5 12" stroke="rgba(255,255,255,0.75)" strokeWidth="1.5"
            strokeLinecap="round" strokeOpacity="0.35"/>
          <circle cx="26" cy="12" r="2.5" stroke="rgba(255,255,255,0.75)" strokeWidth="1.5" strokeOpacity="0.35"/>
        </svg>
      )}
    </div>
  )
